...
@Component({
  ...
  template: `
    ...
    <p>
      Realizamos trabajos a medida y nos desplazaos allá donde nos necesites.
      Sobre todo, nos movemos por Toledo y sus alrededores pero también por
      Madrid y zonas próximas.
    </p>
    <p>
      Si necesitas un trabajo para un destino más lejano ponte en contacto con
      nosotros y te propondremos una solución.
    </p>
    <img
      alt="algo"
